...
<body>
    ...
    $busqueda=$_POST['busquedaProducto'];
        try 
        {
            ...
            //PASO 2
            $sql= "SELECT SECCIÓN, PRODUCTOS,PAIS,PRECIO FROM artículos WHERE PRODUCTOS=?";
          ...
          $ok=$resultado->execute(array($busqueda));//en ves de poner el string nosotros ponesmo el valor rescatado del input
